...
<div class="container my-5">
  <div class="row">
    <div>
      <h1 class="page-title mb-4">Report : Nationality</h1>
    </div>
                            ...
                            <th align="right">07-10-2023</th>
                              ...
                              <tbody>
                                ...
                                foreach ($datax as $dt){
                                  ...
                                  $count=DB::table('registered_users')->where('nationality',$dt->nationality)->count();
                                  $sno++;
                                  $count1=DB::table('registered_users')->where('nationality',$dt->nationality)->where('rdate','2023-10-07')->count();
                                  $count2=DB::table('registered_users')->where('nationality',$dt->nationality)->where('rdate','2023-10-08')->count();
                                  $count3=DB::table('registered_users')->where('nationality',$dt->nationality)->where('rdate','2023-10-09')->count();
$c=$c+$count;
                                  $c1=$c1+$count1;
                                  $c2=$c2+$count2;
                                  $c3=$c3+$count3;
